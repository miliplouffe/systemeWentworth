...
statutGicleurMontrealFalse = 1
statutGicleurWentworth_NordTrue = 1
statutGicleurWentworth_NordFalse = 0

statutGicleurTrue=statutGicleurMontrealTrue
statutGicleurFalse=statutGicleurMontrealFalse
    ...
    def clicked_btn_action(self, value):
        ...
        if value=="OuvrirMessages":
            ...
            for keys in tableData:
                ...
                print ("0000000000000000000",messageRec)  
...
def sauvegardeMessageActivites(DateHeureCourante,NoZone,Message):
    messageActivite = dc.MESSAGES_ACTIVITES(DateHeureCourante, NoZone, Message)
    messageActivite.DateMessage=DateHeureCourante
